...
\e[35m   Discord: medusamarka || 


\e[31m              ~ Coded By Batu - Discord medusamarka ~
...
read -p "Sayı Girin(Default=1): " islem
...
apt update -y
	...
	clear
        echo -e '\033[36;40;1m Doğru Numara Girdiğinden Emin Ol Bro....'	
	sleep 3
	clear 
fi
